...
class CSteamEnvVars {
public:
	CSteamEnvVars() : m_SteamAppId( "SteamAppId" ),
			...
			if ( pszFoundShortName ) {
				do {
					...
					if ( pszFoundShortName[ 0 ] != '.' && ( initInfo.m_pFileSystem->FindIsDirectory( findHandle ) || V_stristr( pszFoundShortName, ".vpk" ) ) ) {
						...
						if (
							!V_stricmp( pszFoundShortName, "materials" ) || !V_stricmp( pszFoundShortName, "maps" ) || !V_stricmp( pszFoundShortName, "resource" ) || !V_stricmp( pszFoundShortName, "scripts" ) || !V_stricmp( pszFoundShortName, "sound" ) || !V_stricmp( pszFoundShortName, "models" ) ) {
