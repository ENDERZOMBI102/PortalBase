...
#define SWAP( a, b ) ( swap_bytes( static_cast<char*>( a ), static_cast<char*>( b ), size ) )

#define COMP( ctx, a, b ) ( (*comp)( static_cast<void*>( ctx ), static_cast<void*>( a ), static_cast<void*>( b ) ) )

/* subfiles of T or fewer elements will
 * be sorted by a simple insertion sort
 * Note!  T must be at least 3
 */
#define T 7

using QSortCompareFunc_t = int(*)( void* context, const void*, const void* );
extern "C" void qsort_s( void* basep, size_t nelems, size_t size, QSortCompareFunc_t comp, void* ctx ) {
