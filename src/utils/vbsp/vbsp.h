...
public:
	...
	static const char* GetInstancePath() { return m_InstancePath; }
...
void Cubemap_CreateDefaultCubemaps();
void Cubemap_SaveBrushSides( const char* pSideListStr );
void Cubemap_FixupBrushSidesMaterials();
void Cubemap_AttachDefaultCubemapToSpecularSides();
...
void OverlayTransition_EmitOverlayFaces();
